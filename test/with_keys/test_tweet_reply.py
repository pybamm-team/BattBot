...
#         tweet_text = (
#             "Compare SPMe and DFN model with Chen2020 parameters with a 1C discharge at"  # noqa
#             " 278.15K"
#         )
#         reply.generate_reply(tweet_text)
...
#         tweet_text = (
#             'Vary "Negative electrode porosity" with values [0.3, 0.4g, 0.5f] with SPM '  # noqa
